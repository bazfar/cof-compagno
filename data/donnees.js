          ...
          { rang: 5, nom: "Maîtrise tactique", effet: "Capacité finale de maîtrise tactique (voir le manuel officiel pour le détail exact)",
            mecanique: { type: "limitee", usage: { frequence: "1x/combat" }, cible: "soi", portee: null, zone: null, jetOppose: null,
              effets: [ { type: "etat", id: "maitrise_tactique", duree: "3" },
                { type: "special", note: "Pose l'état 'maitrise_tactique' : Capacites.resoudreEffet double la magnitude de Posture de combat tant qu'il est actif (cf. son commentaire). Combat en phalange (+2 attaque/DEF par allié au contact au lieu de +1) reste non modélisé — bonus scalant avec un décompte d'alliés, comme documenté à son propre rang." } ] } },
        ],
      },
      {
        nom: "Voie du peuple",
