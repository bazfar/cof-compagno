...
const FACTIONS = [
  ...
  },
  {
    ...
    histoire:
      "La Rupture n'a pas donné naissance à un royaume, mais à quatre — chacun scellant l'armistice séparément plutôt que sous une couronne commune, refusant de rejouer, même dans la victoire, la centralisation qu'ils venaient de fuir.\n\nTrois batailles ont forgé cette coalition improbable. La Charge de Fossessainte, où un jeune chevalier sans grade nommé Alaric a transformé une déroute en victoire et fondé, sans le savoir, tout un code chevaleresque. Le Siège de Mornhaven, où Mornac n'a tenu que grâce aux convois de vivres envoyés par Serval à travers ses cols — le moment où l'alliance militaire est devenue une alliance réelle. Et la Bataille du Pont-Rompu, où ce même Alaric, devenu commandant respecté, est mort en détruisant un pont pour couvrir la retraite coalisée.\n\nL'Armistice des Quatre Sceaux, signé un mois plus tard près de Pont-Rompu, porte la marque de cette méfiance fondatrice : chaque maison y appose son sceau séparément, refusant jusqu'au bout un sceau commun qui aurait trop ressemblé à une nouvelle couronne.\n\nCent soixante-dix ans plus tard, la Coalition tient toujours — mais l'union née dans le sang du champ de bataille s'effrite avec le temps qui passe et l'absence d'ennemi commun immédiat. Arveth, en première ligne face à Solvarn, est aujourd'hui le maillon qui pourrait la faire basculer.",
    intro:
  ...
  },
  {
    ...
    histoire:
      "Liberra est née de la même Grande Sécession que les Royaumes Coalisés, mais d'un refus plus radical : ni empire, ni couronne, ni seigneurs. Les fondateurs de la République ont rejeté jusqu'au principe féodal que même les maisons sécessionnistes avaient conservé, pariant sur une Assemblée de citoyens plutôt que sur une nouvelle noblesse.\n\nLa charte fondatrice, conservée sous verre au Palais du Serment, promettait une liberté gagnée plutôt qu'héritée — et une place, même inégale, pour les non-humains, à une époque où Solvarn les qualifiait déjà de vecteurs de corruption. Cet idéal a attiré une majorité Aelindra et une minorité Mordanel en exil, qui ont fait de Libris un carrefour unique sur le continent.\n\nMais l'idéal fondateur a vieilli différemment de ses ambitions. Le commerce fluvial a fait la fortune du Comptoir avant celle de l'Assemblée elle-même ; les féodalités environnantes poussent la République à se doter d'une défense permanente plutôt que de milices citoyennes ponctuelles.\n\nEt le Silence de Valmoire, il y a environ dix-huit ans, a fait naître le plus jeune de ses cinq blocs : les Fils de Libris, nés du ressentiment de ceux que le miracle marchand de la République a laissés pour compte — une ironie que la République préfère ne pas trop regarder en face, elle qui a fui la rhétorique de pureté de Solvarn pour la voir renaître, sans le nom, dans ses propres rues.",
  ...
  },
  {
    ...
    entites: [
      ...
      },
      {
        ...
        description:
          "Dépositaires des mystères les plus anciens, dont le Marteau-Premier — bien au-delà de l'écriture runique enseignée à Forge-Runez. C'est un maître Runegrave, et non un Sombreforge, qui a gravé la rune interdite du Scellement : ce clan porte donc le véritable poids théologique de la décision, en silence, plutôt que la fierté martiale des Sombreforge. La plupart des Gardiens du Marteau actuels en sont issus. Ferrune leur sert de vivier — les apprentis les plus doués de Forge-Runez, une fois choisis, y sont admis pour les runes que même Forge-Runez n'enseigne pas.",
      },
      {
  ...
  },
  {
    ...
    entites: [
      ...
      },
      {
        ...
        description:
          "Donne son nom à la forge de guerre de Karag Dûm. Le clan évolutionniste le plus fervent, celui qui porte le plus ouvertement le rêve de reconquête de Kaldrun. Pas encore assez puissant pour fédérer les autres clans évolutionnistes derrière lui — mais son chef actuel y travaille activement (PNJ à nommer si Thomas veut activer ce hook). Le jour où un clan Grimgal unifié rassemblerait les autres, le rêve latent deviendrait une vraie menace militaire.",
      },
      {
