...
const CHRONOLOGIE = [
  ...
  },
  {
    ...
    peuples: ["elfes", "chaos"],
    description:
      "Poussés par les Enfants de la Sève, des servants elfes accomplissent un rituel destiné à défaire le concept de Mort porté par Ysmaal, quatrième Gardien, seul concept majeur jamais apparié du panthéon. Mais un dieu est son concept : atteindre l'un tue l'autre. Le rituel fracture littéralement le continent occidental et sépare l'ancienne capitale elfique du reste du monde — naissance de l'archipel au nord-est. Les elfes qui l'ont accompli, exilés avec les Enfants bannis, deviennent les Sylvareth.",
  },
  {
    id: "chute-nyaleth",
