...
const FACTIONS = [
  ...
  {
    groupe: "Les Nains — Kaldrun & Khazrak Dûm",
    // Blasons absents tant qu'ils n'ont pas été déposés dans assets/blasons/
    // (repli silencieux côté rendreFactions(), pas d'icône cassée — voir
    // assets/blasons/README.md pour la convention de nommage).
    intro:
      "Un seul peuple, un seul dieu, deux destins. Une bataille tragique (à développer) referme l'accès méridional des Contreforts et coupe pour toujours certaines tribus de Kaldrun — l'isolement forcé, puis un pacte de survie avec les orcs des Failles Rouges, ont fait de Khazrak Dûm un miroir déchu de l'Ordre plutôt qu'un peuple étranger. Les deux nations partagent la même origine (élémentaires de pierre éveillés par l'attention de Valdaan) et la même prière — la forge — mais n'en gardent plus le même vocabulaire.",
    entites: [
      {
        nom: "Nains de l'Ordre — Kaldrun",
        devise: "Ce qui est forgé dans la mémoire ne s'oublie pas.",
        blason: "assets/blasons/blason_nains_ordre.png",
        description:
          "Capitale souterraine : Kaldrun, \"la Cité sous la Montagne\", dans les Contreforts de Serval. Gouvernés par les Gardiens du Marteau, prêtres-artisans qui ne séparent jamais la foi de la forge — vénèrent Valdaan à chaque coup de marteau, jamais les mains vides.\nAlliance : Serval, scellée par le sang et la métallurgie (cf. Torvald Sten, Kettil Rhennar) — Serval fournit la protection politique et un débouché commercial, Kaldrun la technique et l'acier.\nForge-Runez, au sud de la capitale, forme les apprentis du royaume à l'écriture runique avant leur admission dans les forges profondes — les mystères les plus anciens restent sous la montagne.\nFracture/hook : Thrakan Kelgarn, chef d'un clan Résistant khazrak dûm, cherche depuis des années un intermédiaire pour renouer un contact avec Kaldrun — l'Ordre n'a jamais officiellement répondu. Certains Gardiens du Marteau y verraient une réconciliation possible, la majorité y voit une hérésie qu'on ne peut pas simplement pardonner.\nMiroir : Khazrak Dûm — le même peuple, la même prière, deux destins qui divergent depuis une bataille qu'on ne raconte plus qu'à demi-mot.",
      },
      {
        nom: "Khazrak Dûm — Karag Dûm",
        devise: "Ce qu'on nous a pris, nous le reprendrons.",
        blason: "assets/blasons/blason_khazrak_dum.png",
        description:
          "Capitale : Karag Dûm, dans les Failles Rouges à l'est de Liberra, en bordure des terres orques. Nation née d'un isolement forcé (bataille tragique, à développer) puis d'un pacte de survie avec les tribus orques et gobelines — pacte qui les a transformés physiquement (plus grands, peau grisée, mâchoire proéminente) autant que culturellement.\nScindés en deux factions : les Résistants, campés aux abords des Failles les plus proches de Kaldrun, refusent toute assimilation nouvelle et espèrent une réconciliation lointaine avec l'Ordre (cf. Thrakan Kelgarn, PNJ clés) ; les Évolutionnistes, enfoncés plus profondément dans les Failles, ont fait du pacte une identité — Grimgal, leur principale forge de guerre, produit des armes efficaces qu'aucune rune de mémoire ou de patience ne vient plus habiter : un savoir perdu, pas une pratique refusée.\nFracture/hook : l'envie des Évolutionnistes envers la complétude rituelle jamais compromise de l'Ordre s'est transformée, de génération en génération, en un rêve fondateur — reprendre un jour Kaldrun, ou au moins ses forges sacrées. Tension de fond, pas (encore) une menace militaire active.\nMiroir : Nains de l'Ordre — le même peuple, avant la bataille qui les a séparés.",
      },
    ],
    synthese:
      "Le rapport Ordre/Khazrak Dûm n'est pas une simple rivalité de territoire : c'est une fracture théologique vécue différemment des deux côtés. L'Ordre y voit une souillure qu'on ne peut pas simplement effacer par la nostalgie de Thrakan ; les Évolutionnistes y voient la preuve vivante qu'ils avaient un autre choix et l'ont perdu par nécessité plutôt que par lâcheté — ce qui rend l'existence même de Thrakan et des Résistants une provocation silencieuse pour les Évolutionnistes, qui verraient toute réconciliation comme un abandon du rêve collectif de reconquête.\n\nCe qui pourrait faire basculer l'équilibre : la découverte que le rêve de reconquête des Évolutionnistes prend une forme concrète (un chef de guerre, une première tentative sur un col de Serval) forcerait Torvald Sten à choisir entre protéger discrètement la frontière ou révéler publiquement une menace qui inquiéterait toute la Coalition ; une réconciliation réussie entre Thrakan et un Gardien du Marteau ouvert d'esprit pourrait fracturer les Évolutionnistes de l'intérieur, entre ceux qui y verraient un espoir et ceux qui y verraient une trahison à punir.",
  },
];
