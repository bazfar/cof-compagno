          ...
          { rang: 5, nom: "Requiem du silence (L, 1x/combat)", effet: "Zone large : échec à un test de Volonté → Réduit au silence (aucune capacité magique/vocale) et -4 attaque pendant 2 tours",
            mecanique: { type: "limitee", usage: { frequence: "1x/combat" }, cible: "zone", portee: null, zone: null,
              ...
              effets: [ { type: "etat", id: "silencieuse", duree: "2" }, { type: "bonus", cible: "attaque", valeur: -4, duree: "2" },
                { type: "special", note: "caracDefenseur 'Volonte' (≠ 'DEF') : le jet du Barde est roulé et affiché, mais jamais comparé automatiquement — data/bestiaire.json n'expose que pv/def/init/atk, aucun modificateur de SAG/CHA par monstre à opposer (contrairement à un PJ cible, où Personnage.mod('SAG') existe). Message clarifié (Capacites.lancer) pour au moins nommer la caractéristique à comparer manuellement. mecanique.cible = 'zone' : comme pour les autres capacités de zone, aucune application automatique multi-cible — à résoudre cible par cible à la table." } ] } },
        ],
      },
      {
        nom: "Voie du chaos",
          ...
          { rang: 1, nom: "Chant corrupteur (performance)", effet: "Test de CHA opposé, portée vocale : la cible en échec est Influencée (-2 à une carac. ou vulnérabilité à la suggestion) quelques tours. +1 CS",
            mecanique: { type: "activable", corruption: 1, usage: { frequence: "libre" }, cible: "ennemi", portee: null, zone: null,
              ...
              effets: [ { type: "etat", id: "influencee", duree: "3" },
                { type: "special", note: "+1 CS (jauge de Chaos) déjà tracké via mecanique.corruption (correction d'une note obsolète qui le disait 'non trackée'). caracDefenseur 'CHA' (≠ 'DEF') : jet du Barde roulé et affiché, jamais comparé automatiquement — data/bestiaire.json n'expose pas de modificateur de CHA par monstre à opposer. Message clarifié (Capacites.lancer) pour nommer la caractéristique à comparer manuellement." } ] } },
          ...
          { rang: 3, nom: "Mélopée de la Folie (L)", effet: "Zone, test opposé par cible : échecs → confusion chaotique (attaquent au hasard, alliés compris) quelques tours. +2 CS. Critique : jet sur la table de mutation Palier 1",
            mecanique: { type: "limitee", corruption: 2, usage: { frequence: "libre" }, cible: "zone", portee: null, zone: null,
              ...
              effets: [ { type: "etat", id: "confuse", duree: "3" },
                { type: "special", note: "+2 CS (jauge de Chaos, déjà tracké via mecanique.corruption). Critique : jet sur la table de mutation Palier 1 — non automatisé. caracDefenseur 'SAG' (≠ 'DEF') : même limite que Chant corrupteur (rang 1, même voie) — jet du Barde affiché, jamais comparé automatiquement faute de modificateur de SAG par monstre dans data/bestiaire.json. mecanique.cible = 'zone' : comme les autres capacités de zone, résolution manuelle cible par cible." } ] } },
