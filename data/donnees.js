          ...
          { rang: 3, nom: "Mélopée de la Folie (L)", effet: "Zone, test de CHA vs DEF par cible : touché → confusion chaotique (attaquent au hasard, alliés compris) quelques tours. +2 CS. Critique : jet sur la table de mutation Palier 1",
            mecanique: { type: "limitee", corruption: 2, usage: { frequence: "libre" }, cible: "zone", portee: null, zone: null,
              ...
              effets: [ { type: "etat", id: "confuse", duree: "3" },
                { type: "special", note: "+2 CS (jauge de Chaos, déjà tracké via mecanique.corruption). Critique : jet sur la table de mutation Palier 1 — non automatisé, VOLONTAIREMENT laissé ainsi (audité mais pas implémenté, validé avec Thomas) : cette table 'Palier 1' est référencée à l'identique par au moins 6 autres capacités rang 3 de Voie du chaos, toutes classes confondues (Nécromancien, Magicien, Druide, Chasseur, Chevalier, Enchanteur...) et n'existe nulle part comme donnée structurée (contrairement à _rollMutationSauvage, propre au Magicien/Voie de la magie sauvage, qui est un mécanisme différent) — l'automatiser pour le Barde seul serait incohérent ; à traiter comme un chantier transverse dédié si besoin. Simplifié (validé avec Thomas) : caracDefenseur passé de 'SAG' à 'DEF', même principe que Chant corrupteur (rang 1, même voie) — désormais pleinement automatisé (touché/raté/critique) une fois une cible choisie. mecanique.cible = 'zone' sans cibleId automatique : le sélecteur de cible (app.js) est étendu aux capacités 'zone' avec jetOppose pour choisir un monstre de la zone à la fois et relancer pour le suivant." } ] } },
      ...
      },
      {
        ...
        rangs: [
          ...
          { rang: 2, nom: "Capture d'âme (sort, L, 10 m)", effet: "Attaque magique pour capturer l'âme d'une créature qui vient de mourir. Stockée dans un réceptacle ; max 3 simultanées",
            mecanique: { type: "limitee", usage: { frequence: "libre" }, cible: "ennemi", portee: 10, zone: null, jetOppose: null, ameGain: 1,
