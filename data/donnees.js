...
const LORE = {
  ...
  intro:
    "Campagne maison — Document de référence. L'Arbre-Monde · La Fracture · Les Races · Les Nations Elfiques · Les Systèmes Humains · Les Consciences-Émotions · Le Chaos. Version 1.0 — Juin 2026",
  sections: [
    {
      titre: "Cosmogonie et origines du monde",
      contenu:
        "L'Arbre-Monde\n\nÀ l'origine de tout se dresse l'Arbre-Monde — axis de la création, siège des dieux et source de toute vie. Son écorce est le temps, sa sève est la magie, ses racines plongent dans des plans que nul mortel n'a jamais atteints. C'est à son sommet que siège le Trône de l'Arbre-Monde, source du pouvoir divin absolu.\n\nLe Panthéon Elfique — Les Deux Factions\n\nLes premiers dieux à émerger de l'Arbre sont les dieux elfiques, divisés en deux factions opposées :\n\n• Gardiens de l'Écorce (Ordre · Stase · Préservation) : veulent que l'Arbre reste immuable, parfait, fermé au monde extérieur. Ce sont eux qui gagnent la Guerre du Trône.\n\n• Enfants de la Sève (Croissance · Expansion · Vie) : veulent que l'Arbre croisse et engendre d'autres mondes. Bannis et corrompus lors de la Fracture — ils deviennent les Dieux du Chaos.\n\nLa Guerre du Trône\n\nLa guerre éclate quand les Enfants de la Sève cherchent à ouvrir l'Arbre vers d'autres mondes. Des siècles de conflit divin s'ensuivent. Les émotions générées — violence, meurtre, traque — sont d'une intensité telle qu'elles se solidifient en conscience et prennent une existence propre.\n\nLa Fracture\n\n• Défaite des Enfants de la Sève : vaincus, bannis et corrompus — leur désir de croissance devient désir de destruction.\n• L'Arbre blessé : ses racines sont partiellement corrompues. L'Arbre dépérit lentement depuis — un déclin que les Elfes ressentent dans leur chair.\n• Naissance des Humains : le sang versé pendant la Fracture, mêlé des deux factions, tombe sur le monde et prend vie. Les Humains portent l'écho de la guerre : une double nature instable, susceptible au Chaos.\n• Naissance des Dieux du Chaos : les Enfants bannis créent leurs propres serviteurs — les Démons — pour détruire ce qu'ils n'ont pu posséder.",
    },
    {
      titre: "Les races du monde",
      contenu:
        "Les Elfes — Enfants de l'Arbre\n\nPremiers-nés de l'Arbre, antérieurs à la Fracture. Leur sang est de la sève pure (résistance naturelle au Chaos : +2 ou +rang aux jets contre la corruption de la Voie du Chaos). Trois nations :\n\n• Aetharion (Hauts Elfes) : préserver et isoler l'Arbre. Hautains. Bannissent les demi-elfes.\n• Aelindra (Elfes Sylvains) : réparer l'Arbre en tissant des liens avec toutes les races. Présents dans la République. Acceptent les demi-elfes.\n• Mordanel (Elfes du Crépuscule) : garder la mémoire et témoigner. Fracture interne : Anciens prudents contre Jeunes qui veulent agir. Accusés par l'Empire d'avoir provoqué l'incarnation de la Traque.\n\nLes Humains — Sang Mêlé, Fracturé\n\nNés du sang divin des deux camps. Nature instable, ambition insatiable, adaptabilité. -2 aux jets contre la corruption du Chaos, mais accès plus facile à la Voie du Chaos.\n\nLes Nains — Élémentaires de Pierre Éveillés\n\nCréés par un dieu Gardien de la Montagne, devenus conscients. Ancrage dans l'Ordre.\n• Nains de l'Ordre : forge, tradition, alliés de l'Empire. +1 contre la corruption.\n• Khazrak Dûm (Nains Renégats) : ont pactisé avec orcs et gobelins, absorbé leurs traits. Plus grands, peau grisée. Observés par les Dieux du Chaos.\n\nOrcs & Gobelins — Émotions Cristallisées\n\nNés des émotions de violence de la Guerre du Trône.\n• Orcs : nés du meurtre frontal, combattent en horde, regardent dans les yeux avant de tuer.\n• Gobelins : nés de la ruse et de la chasse, embuscades et pièges, plus malléables.",
    },
    {
      titre: "Le Chaos — hiérarchie et manifestations",
      contenu:
        "Hiérarchie du Chaos\n\n• Niveau I — Dieux du Chaos : Enfants de la Sève bannis, pleinement cristallisés. Absents physiquement, influence indirecte.\n• Niveau II — Consciences-émotions (Violence / Meurtre / Traque) : pas encore des dieux. Bénédictions sur champions. Rarement : incarnation temporaire.\n• Niveau III — Démons : serviteurs créés par les Dieux du Chaos. Actifs dans le monde.\n• Niveau IV — Orcs & Gobelins : corps des consciences dans le monde mortel. Omniprésents.\n\nL'Incarnation de la Traque — l'événement fondateur\n\nPour la première fois depuis des siècles, la conscience de la Traque s'est incarnée. Elle a chassé méthodiquement des villages entiers, silencieusement, à la manière d'une magie elfique plutôt que d'une attaque orc frontale.\n\nL'Empire l'a utilisé : il a désigné les Mordanel comme responsables. Mensonge délibéré ou conviction sincère ? C'est une ambiguïté narrative centrale de la campagne. Et si les Dieux du Chaos avaient manipulé les deux camps simultanément ?",
    },
    {
      titre: "Les trois systèmes humains",
      contenu:
        "Tous les Humains partagent la même origine — le sang divin fracturé. Après la Grande Sécession du Premier Empire, trois systèmes se disputent le monde connu.\n\n• L'Empire (Xénophobe · Centralisé · Religieux) : héritier du Premier Empire, revendique le sang des Gardiens de l'Écorce. Doctrine : la pureté du sang humain comme rempart au Chaos ; les non-humains sont des vecteurs de corruption. Ironie : l'Empire a raison sur un point (les Humains sont plus susceptibles au Chaos), appliqué de façon monstrueuse.\n\n• Les Royaumes Coalisés (Chevaleresques · Féodaux · Hypocrites) : anciens nobles sécessionnistes. Seigneurs → Chevaliers → Paysans. Code d'honneur souvent dévoyé par l'aristocratie. Neutralité armée face à l'Empire, alliance inconfortable avec la République.\n\n• La République (Idéaliste · Inclusive · Fracturée) : née de la Sécession, rupture avec l'Empire et le féodalisme. Assemblée de citoyens, non-humains admis (représentation inégale). Majorité Aelindra. Fractures internes : marchands, idéalistes, militaires, communautés non-humaines.\n\nTensions actuelles : Empire → Royaumes (reconquête) ; Empire → République (hérésie raciale) ; Empire → Aetharion (guerre ouverte) ; Royaumes ↔ République (alliance méfiante) ; République ↔ Aelindra (alliance naturelle).",
    },
    {
      titre: "Éléments en construction (notes MJ)",
      contenu:
        "Noms propres à définir : nom de l'Empire et de sa capitale ; noms des Royaumes Coalisés ; nom de la République et de sa capitale ; noms des dieux elfiques.\n\nGéographie : carte des territoires ; localisation de l'Arbre-Monde ; les Pics Lointains des Khazrak Dûm ; frontières Empire / Elfes.\n\nReligion & Magie : structure et dogme de l'Église impériale (inquisition ?) ; pratiques religieuses elfiques ; nature de la magie (liée à l'Arbre-Monde ?).\n\nHistoire récente : la Grande Sécession (quand, comment ?) ; lieu exact de l'incarnation de la Traque ; état actuel de la guerre Empire / Elfes.",
    },
  ],
};
