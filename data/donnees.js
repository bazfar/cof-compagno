    ...
    voies: [
      ...
      },
      {
        ...
        rangs: [
          ...
          { rang: 3, nom: "Chant brisant (L)", effet: "Zone 3 cases, portée 7 cases : tous les ennemis subissent -2 attaque et -2 DEF pendant [3+Mod. de CHA] tours",
            mecanique: { type: "limitee", usage: { frequence: "libre" }, cible: "zone", portee: 7, zone: 3, jetOppose: null,
              effets: [ { type: "bonus", cible: "attaque", valeur: -2, duree: "3+Mod.CHA" },
                { type: "bonus", cible: "DEF", valeur: -2, duree: "3+Mod.CHA" },
                { type: "special", note: "Zone corrigée de 5 m/2 cases à 3 cases (validé avec Thomas) ; portée déjà à 7 cases (15 m), texte mis à jour pour correspondre. mecanique.portee/zone sont exprimés en CASES (cf. _armerCiblageCarte côté app.js) : au lancer, sélection d'un monstre de la zone via un picker armé sur la carte (jetons en portée surlignés), avec aperçu au survol des AUTRES jetons dans le rayon de zone (halo orange, cf. rendreTokensDD/rayonZoneCases côté js/carte.js) — le reste (application du -2 attaque/DEF à TOUS les ennemis de la zone) reste manuel, comme les autres capacités de zone à bonus (ex. Cri du rassemblement)." } ] } },
