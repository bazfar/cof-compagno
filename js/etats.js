...
const ETATS = {
  ...
  premiers_secours: { nom: "Premiers secours", categorie: "buff",
    description: "Prochain jet de mort automatiquement réussi (Prêtre, sort Premiers secours, rang 1) — consommé par App.jetDeMort, que ce soit ou non le 3e succès qui stabilise." },
  bastion_arcanique: { nom: "Bastion arcanique", categorie: "buff",
  ...
  chatiment_calcinant_actif: { nom: "Châtiment calcinant (actif)", categorie: "buff",
    description: "Arme enchantée tant que l'état est maintenu (Magicien, sort Châtiment calcinant, rang 1) — motCle 'maintenue', coûte 1 PP/tour (cf. coutMaintienPP). La prochaine attaque de contact touchée par cette arme infligera +1d6 dégâts de feu, puis l'état se dissipe — bonus conditionné à une attaque ultérieure, application manuelle par la table (même limite que Frappe purificatrice du Prêtre)." },
  chatiment_sacre_actif: { nom: "Châtiment (actif)", categorie: "buff",
    description: "Arme enchantée tant que l'état est maintenu (Prêtre, sort Châtiment, rang 1, Jugement) — motCle 'maintenue', coûte 1 PP/tour. La prochaine attaque de contact touchée sur une cible Marquée infligera +1d8 dégâts sacrés, puis l'état se dissipe — même limite que Frappe purificatrice (marque non vérifiable automatiquement côté monstre)." },
  aura_sacree_active: { nom: "Aura sacrée (active)", categorie: "buff",
    description: "Armes du lanceur et de ses alliés en zone enchantées tant que l'état est maintenu (Prêtre, sort Aura sacrée, rang 2, Jugement) — motCle 'maintenue', coûte 1 PP/tour. Chaque attaque de contact touchée par le lanceur ou un allié dans la zone (3 cases) infligera +1d8 dégâts sacrés — bonus de zone non modélisé (mecanique.cible='zone' sans cibleId automatique, même limite que Globe de protection), application manuelle par la table." },
  marque_eclair: { nom: "Marque de l'éclair", categorie: "dot",
    description: "1d8 dégâts électriques en début de tour tant que l'état dure (Magicien, sort Éclair traçant, rang 2) — cf. formuleDot, décompté par Capacites.decompterEtatsDebutTour comme tout autre DOT." },
  marque_chatiment_ame: { nom: "Marqué (Châtiment de l'âme)", categorie: "malus",
    description: "La prochaine fois que la cible est touchée par une attaque de contact (la sienne ou celle d'un allié du lanceur), elle doit réussir une sauvegarde de Vigueur DD 15 sous peine de subir 3d8 dégâts magiques supplémentaires (Magicien, sort Châtiment de l'âme, rang 4) — déclenchement conditionné à une attaque ultérieure d'un tiers, non modélisé par le moteur, application manuelle par la table." },
  prisonniere_illusoire: { nom: "Prisonnière (illusion)", categorie: "controle",
    description: "Ne peut plus quitter sa case (Magicien, sort Prison mentale, rang 5). Si elle se déplace elle-même ou est déplacée par un tiers, l'illusion se brise immédiatement et elle subit 8d8 dégâts magiques supplémentaires — immobilisation conditionnelle et déclenchement au déplacement non modélisés par le moteur (pas de suivi de position des jetons dans l'app), application manuelle par la table." },
  aura_vitalite_active: { nom: "Aura de vitalité (active)", categorie: "buff",
    description: "Régénère 1d8 PV en début de tour tant que l'état dure (Prêtre, sort Aura de vitalité, rang 3, Guérison) — cf. formuleSoin, symétrique de formuleDot. Coûte 2 PP/tour au lanceur (cf. coutMaintienPP). mecanique.cible='zone' sans cibleId automatique : application manuelle allié par allié dans la zone (5 cases), même limite que Sanctuaire du gardien (Druide)." },
};
